...
private fun WorkoutContentPreview() {
    EvoFitTheme {
        WorkoutContent(
            userName = "Augusto",
            workouts = listOf(
                WorkoutUIModel("1", "Back", 6, 20, R.drawable.ic_back_2),
                WorkoutUIModel("2", "Chest", 6, 18, R.drawable.ic_chest_2),
                WorkoutUIModel("3", "Legs", 8, 24, R.drawable.ic_legs_3),
                WorkoutUIModel("4", "Biceps", 6, 18, R.drawable.ic_arms_2),
                WorkoutUIModel("5", "Triceps", 6, 18, R.drawable.ic_arms_2),
                WorkoutUIModel("6", "Forearms", 4, 12, R.drawable.ic_arms_2),
                WorkoutUIModel("7", "Shoulders", 5, 15, R.drawable.ic_shoulder_2),
                WorkoutUIModel("8", "Core", 5, 15, R.drawable.ic_core_2),
                WorkoutUIModel("9", "Cardio", 4, 0, R.drawable.ic_cardio_2),
            ),
            totalWorkouts = 124,
            workoutsThisWeek = 3,
            history = emptyList(),
