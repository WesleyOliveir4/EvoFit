...
fun NewWorkoutScreenPreview() {
    EvoFitTheme {
        NewWorkoutContent(
            muscleGroups = listOf(
                MuscleGroupItem("1", "Back", imageRes = R.drawable.ic_back_2),
                MuscleGroupItem("2", "Chest", imageRes = R.drawable.ic_chest_2),
                MuscleGroupItem("3", "Legs", imageRes = R.drawable.ic_legs_3),
                MuscleGroupItem("4", "Biceps", imageRes = R.drawable.ic_arms_2),
                MuscleGroupItem("5", "Triceps", imageRes = R.drawable.ic_arms_2),
                MuscleGroupItem("6", "Forearms", imageRes = R.drawable.ic_arms_2),
                MuscleGroupItem("7", "Shoulders", imageRes = R.drawable.ic_shoulder_2),
                MuscleGroupItem("8", "Core", imageRes = R.drawable.ic_core_2),
                MuscleGroupItem("9", "Cardio", imageRes = R.drawable.ic_cardio_2),
                MuscleGroupItem("10", "Glutes", imageRes = R.drawable.ic_gluteus_2),
                MuscleGroupItem("11", "Calves", imageRes = R.drawable.ic_calf_2),
            ),
