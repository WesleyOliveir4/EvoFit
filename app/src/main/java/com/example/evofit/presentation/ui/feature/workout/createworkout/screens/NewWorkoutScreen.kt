...
fun NewWorkoutScreenPreview() {
    EvoFitTheme {
        NewWorkoutContent(
            muscleGroups = listOf(
                MuscleGroupItem("1", "Back", imageRes = R.drawable.ic_back),
                MuscleGroupItem("2", "Chest", imageRes = R.drawable.ic_chest),
                MuscleGroupItem("3", "Legs", imageRes = R.drawable.ic_legs_2),
                MuscleGroupItem("4", "Biceps", imageRes = R.drawable.ic_arms),
                MuscleGroupItem("5", "Triceps", imageRes = R.drawable.ic_arms),
                MuscleGroupItem("6", "Forearms", imageRes = R.drawable.ic_arms),
                MuscleGroupItem("7", "Shoulders", imageRes = R.drawable.ic_shoulder),
                MuscleGroupItem("8", "Core", imageRes = R.drawable.ic_core),
                MuscleGroupItem("9", "Cardio", imageRes = R.drawable.ic_cardio),
                MuscleGroupItem("10", "Glutes", imageRes = R.drawable.ic_gluteus),
                MuscleGroupItem("11", "Calves", imageRes = R.drawable.ic_calf),
            ),
